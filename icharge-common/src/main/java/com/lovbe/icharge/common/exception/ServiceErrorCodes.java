...
public interface ServiceErrorCodes {
    ...
    //========== 公共模块 ==========
    ErrorCode FILE_IS_NULL = new ErrorCode(400, "上传文件不得为空");
    ErrorCode FILE_URL_IS_NULL = new ErrorCode(400, "文件地址不得为空");
    ...
    ErrorCode LATEX_2_SVG_FAILED = new ErrorCode(400, "公式转换失败，请稍后再试");
